import { useColorTheme } from '@tallo/themes';
...
export const ActivityIndicator = ({
  ...
  const color = indicatorColor || theme.colors?.brand;
  const size =
    typeof indicatorSize === 'string' ? (indicatorSize === 'small' ? 16 : 48) : indicatorSize ? indicatorSize : 24;
  ...
  return (
    <View
      ...
      testID={testID ? testID : 'activity-indicator'}
    >
