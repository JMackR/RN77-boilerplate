import { useColorsForTextColorsCollection, useFontForTextType } from '@tallo/themes';
...
export const ComputePropsForTextEntryProps = (props: TextEntryProps) => {
  ...
  const [primaryColor, hintColor, tintColor] = useColorsForTextColorsCollection([
    ...
    hintColorName !== undefined ? hintColorName : 'primary',
    tintColorName !== undefined ? tintColorName : 'primary',
  ]);
