import { Flex, Margin, Stack, Text } from '@tallo/core-ui-library';
import { useColor } from '@tallo/themes';
import { Platform, StyleProp, StyleSheet, Switch, ViewStyle } from 'react-native';
...
export const Toggle = (props: ToggleProps) => {
  ...
  const backgroundColor = Platform.OS === 'ios' ? colors.gray : colors.gray;
