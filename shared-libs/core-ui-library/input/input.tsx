    ...
    <Flex direction={'row'} grow={1} testID={`${testID || 'ucl'}.input`}>
      <Margin direction={'column'} grow={1}>
        <Stack direction={'column'} childSeparationStep={1}>
            ...
            <Flex grow={1} direction={'row'}>
              {title && (
                <Text
                  ...
                  color={titleColor ? titleColor : 'primary'}
                >
                  {title}
                </Text>
              )}
          ...
          <BackgroundContainer
            type={background ? background : 'paceBlue'}
            borderRadius={10}
                  ...
                  {secureTextEntry && (
                    <Overlay insetRightStep={0}>
                      <TouchableOpacity onPress={toggleSecure}>
                        <Text textType={'bodyMedium1'} color={'primary'} maxFontSizeMultiplier={maxFontSizeMultiplier}>
                          {secure ? 'show' : 'hide'}
                        </Text>
                      </TouchableOpacity>
                    </Overlay>
