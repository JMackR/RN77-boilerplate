...
import { deepFreeze } from '@tallo/utilities/object-utils';
...
import PlayCircleSVG from './svgs/actions/play-circle.svg';
import PauseSVG from './svgs/actions/pause.svg';
import StopSVG from './svgs/actions/stop.svg';
...
export const StopIcon: LocalSVGSource = deepFreeze({
  SVG: StopSVG,
});
export const PlayIcon: LocalSVGSource = deepFreeze({
  SVG: PlayCircleSVG,
});
...
export const ActionEllipsisFillIcon: LocalSVGSource = deepFreeze({
  SVG: EllipsisFill,
});
