...
jest.mock('@tallo/core-ui-library', () => {
  return {
...
describe('SkeletonLoader component', () => {
  it('renders correctly with light theme', () => {
    require('@tallo/themes').setTestColorTheme('light_mode');
  ...
  it('renders correctly with dark theme', () => {
    require('@tallo/themes').setTestColorTheme('dark_mode');
