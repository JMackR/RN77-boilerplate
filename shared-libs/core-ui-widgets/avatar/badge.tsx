...
import { SVG, isJSXElement, isLocalSVGSource } from '@tallo/core-ui-library';
...
export const Badge = (props: BadgeProps) => {
  ...
  const checkIcon = () => {
    ...
    if (isJSXElement(icon)) {
      ...
      iconJSX = (
        <SVG localSVG={{ SVG: icon.SVG, size: { height: checkSize * 0.8, width: checkSize * 0.8 } }} tint={iconTint} />
      );
    } else {
      return undefined;
    }
