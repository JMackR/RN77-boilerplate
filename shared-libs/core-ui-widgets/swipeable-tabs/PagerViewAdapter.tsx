...
import ViewPager, { type PageScrollStateChangedNativeEvent } from 'react-native-pager-view';
...
export function PagerViewAdapter<T extends Route>({
  ...
  const onPageScrollStateChanged = (state: PageScrollStateChangedNativeEvent) => {
