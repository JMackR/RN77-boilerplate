import { BufferConfig, DRMType, ISO639_1, SelectedTrackType, TextTrackType } from 'react-native-video';
...
const platformSrc: SampleVideoSource[] = isAndroid ? srcAndroidList : srcIosList;

export const srcList: SampleVideoSource[] = platformSrc.concat(srcAllPlatformList);
