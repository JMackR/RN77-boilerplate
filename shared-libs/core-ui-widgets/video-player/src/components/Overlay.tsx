    ...
    VideoDecoderProperties.getWidevineLevel().then((widevineLevel: number) => {
      VideoDecoderProperties.isHEVCSupported().then((hevc: string) => {
        VideoDecoderProperties.isCodecSupported('video/avc', 1920, 1080).then((avc: string) => {
          toast(true, 'Widevine level: ' + widevineLevel + '\n hevc: ' + hevc + '\n avc: ' + avc);
        });
      });
    });
  }, []);
        ...
        <>
          ...
          <View style={styles.bottomControls}>
            <View style={styles.generalControls}>
              ...
              <ToggleControl isSelected={paused} onPress={togglePause} selectedText="paused" unselectedText="playing" />
              {/* <ToggleControl
                isSelected={repeat}
              ...
              <ToggleControl onPress={openDecoration} text="FullScreen" />
              {/* <ToggleControl
