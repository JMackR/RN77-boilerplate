 ...
 */
export const MaterialTabItem = <T extends TabName = string>(props: MaterialTabItemProps<T>): React.ReactElement => {
  const {
    name,
    index,
    onPress,
  ...
  const renderedLabel = useMemo(() => {
    if (typeof label === 'string') {
      return <Animated.Text style={[styles.label, stylez, labelStyle]}>{label}</Animated.Text>;
    }
