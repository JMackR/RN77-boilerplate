...
const ensureFlastList = () => {
  ...
  try {
    ...
    AnimatedFlashList = Animated.createAnimatedComponent(flashListModule.FlashList) as unknown as React.ComponentClass<
      FlashListProps<any>
    >;
  } catch {
    console.error(
...
const FlashListMemo = React.memo(
  React.forwardRef<FlashListMemoRef, FlashListMemoProps>((props, passRef) => {
    ensureFlastList();
    return AnimatedFlashList ? <AnimatedFlashList ref={passRef} {...props} /> : <></>;
  }),
);
