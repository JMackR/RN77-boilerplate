import type { LocalSVGSource } from '@tallo/core-ui-library';
import type { TextColors, TextTypes, BackgroundColors } from '@tallo/themes';
import { ButtonSize, ButtonType } from '@tallo/core-ui-library/button';
